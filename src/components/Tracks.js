                ...
                <MDBRow>
                    ...
                    <MDBCol lg="8">
                        <Container className="mt-5" style={{ backgroundColor: "white" }}>
                            <h2 className="mb-4" style={{ fontFamily: "Georgina", textAlign: "center", color: "black", fontWeight: "bold" }}>
                            ...
                            <Row className="mb-4 justify-content-center">
                                <Col xs={6} md={3}>
                                    <div className="d-flex flex-column align-items-center">
                                        ...
                                        <Button onClick={handleShowAccountingPage} style={{ fontFamily: "Georgina", backgroundColor: "rgba(4, 55,55, 0.7) ", border: "none" }}>
                                            Show Revenue
                                        </Button>
                                    </div>
                                </Col>
                                <Col xs={6} md={3}>
                                    <div className="d-flex flex-column align-items-center">
                                        ...
                                        <Button onClick={handleShowCustomer} style={{ fontFamily: "Georgina", backgroundColor: "rgba(4, 55,55, 0.7) ", border: "none" }}>
                                ...
                                <Col xs={6} md={3}>
                                    <div className="d-flex flex-column align-items-center">
                                        ...
                                        <Button onClick={handleSchedule} style={{ fontFamily: "Georgina", backgroundColor: "rgba(4, 55,55, 0.7) ", border: "none" }}>
                                            Show Agent Schedule
                                        </Button>
                                    </div>
                                </Col>
                                ...
                                <div>
                                    ...
                                    <Table striped bordered hover>
                                        <thead>
                                            <tr>
                                                <th>
                                                    <img src="em.png" alt="Email" style={{ width: "30px", marginRight: "10px" }} />
                                                    Customer Email
                                                </th>
                                                <th>
                                                    <img src="calendar.webp" alt="Calendar" style={{ width: "30px", marginRight: "10px" }} />
                                                    Date
                                                </th>
                                                <th>
                                                    <img src="desc.png" alt="Description" style={{ width: "30px", marginRight: "10px" }} />
                                                    Description
                                                </th>
                                                <th>
                                                    <img src="amount.png" alt="Amount" style={{ width: "30px", marginRight: "10px" }} />
                                                    Amount
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            {parkingLogs.map((log) => (
                                                <tr key={log.id}>
                                                    <td>{log.email}</td>
                                                    <td>
                                                        <h5 style={{ fontFamily: "Georgina", fontSize: "15px", color: "green" }}>Time in: {log.timeIn && new Date(log.timeIn.seconds * 1000).toLocaleString()}</h5>
                                                        <br />
                                                        <h5 style={{ fontFamily: "Georgina", fontSize: "15px", color: "red" }}>Time out: {log.timeOut && new Date(log.timeOut.seconds * 1000).toLocaleString()}</h5>
                                                    </td>
                                                    <td>
                                                        {log.name} - {log.paymentStatus}
                                                    </td>
                                    ...
                                    <Table striped bordered hover>
                                        <thead>
                                            <tr>
                                                ...
                                                <th>
                                                    <img src="name.png" alt="name" style={{ width: "30px", marginRight: "10px" }} />
                                                    Name{" "}
                                                </th>
                                                <th>
                                                    <img src="cars.jpg" alt="cars" style={{ width: "30px", marginRight: "10px" }} />
                                                    Vehicle{" "}
                                                </th>
                                                <th>
                                                    <img src="plate.png" alt="Plate number" style={{ width: "30px", marginRight: "10px" }} />
                                                    Vehicle Plate Number{" "}
                                                </th>
                                                <th>
                                                    <img src="timein.png" alt="Time in" style={{ width: "30px", marginRight: "10px" }} />
                                                    Time in
                                                </th>
                                                <th>
                                                    <img src="timout.png" alt="Time in" style={{ width: "30px", marginRight: "10px", marginLeft: "20px" }} />
                                                    Time out
                                                </th>
                                            </tr>
                                        </thead>
                                ...
                                <div>
                                    ...
                                    <Table striped bordered hover>
                                        <thead>
                                            <tr>
                                                <th>
                                                    <img src="agent.jpg" alt="Agent Name" style={{ width: "30px", marginRight: "20px" }} />
                                                    Agent Name
                                                </th>
                                                <th>
                                                    <img src="ope.jpg" alt="Email" style={{ width: "30px", marginRight: "20px" }} />
                                                    Email Address
                                                </th>
                                                <th>
                                                    <img src="timein.png" alt="Time in" style={{ width: "30px", marginRight: "20px" }} />
                                                    Time in
                                                </th>
                                                <th>
                                                    <img src="timout.png" alt="Duty Hours" style={{ width: "30px", marginRight: "20px" }} />
                                                    Time out
                                                </th>
                                            </tr>
                                        </thead>
