...
<MDBContainer className="py-5" >
    ...
    >
      ...
      <div className="col-md-3">
        <Card className="mb-3" style={{ height: '220px' , color: '#fff', boxShadow:'none', border:'none'}}>
          <Card.Body>
            <Card.Title style={{ fontFamily: 'Courier New', textAlign: 'center', fontSize: '16px', color: 'black'}}>
              <FontAwesomeIcon icon={faCar} /> Parking Availability
            </Card.Title>
            <Card.Text style={{textAlign: 'center', fontFamily: 'Copperplate', fontSize: '20px', color: 'black'}}>
              {user.totalSlots}
            </Card.Text>
          </Card.Body>
        </Card>
  ...
  <span className="font-italic me-1" style = {{ color:'black', fontWeight: 'bold'}}> Recent Parking User</span>
</MDBCardText>
              <MDBRow>
                  {parkingLogs.map((log) => (
